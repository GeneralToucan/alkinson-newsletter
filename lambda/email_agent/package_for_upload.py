...
def create_deployment_package():
    ...
    print("  Copying shared utilities...")
    shared_dir = os.path.join('..', 'shared')
    if os.path.exists(shared_dir):
        shutil.copytree(shared_dir, os.path.join(deploy_dir, 'shared'))
        print(f"    ✓ Copied shared/ directory")
    else:
        print(f"    ⚠️  Warning: shared/ directory not found")
    ...
    zip_filename = 'email_agent_lambda.zip'
    ...
    print(f"2. Find your 'email_agent' Lambda function")
    print(f"3. Click 'Upload from' -> '.zip file'")
    print(f"4. Select {zip_filename}")
    print(f"5. Click 'Save'")
    print(f"6. Configure environment variables (see AWS_CONSOLE_DEPLOYMENT.md)")
